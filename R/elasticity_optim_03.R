...
#' }
#'
#' @usage data(elasticity_optim_03)
#'
#' @examples
#' \dontrun{
#'   # After loading the package:
#'   data(elasticity_optim_03)
#'   head(elasticity_optim_03)
#' }
NULL
